#include "Framework/UI/SGameUIManagerSubsystem.h"
...
void USGameUIManagerSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	TickHandle = FTSTicker::GetCoreTicker().AddTicker(FTickerDelegate::CreateUObject(this, &USGameUIManagerSubsystem::Tick), 0.0f);
}
